...
# 输入路径
file_input_path = 'D:\\AlibabaTraceAnalysis\\alibaba_clustertrace_2018\\machine_usage.csv'
# 输出路径前缀
file_output_prefix = 'D:\\AlibabaTraceAnalysis\\SplitResult\\machine_usage_'
# 需要保留的列
save_list = [0, 1, 2, 3]
# 时间戳所在列
timestamp_index = 1
