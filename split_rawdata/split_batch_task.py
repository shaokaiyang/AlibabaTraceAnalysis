...
# 输入路径
file_input_path = 'D:\\AlibabaTraceAnalysis\\alibaba_clustertrace_2018\\batch_task.csv'
# 输出路径前缀
file_output_prefix = 'D:\\AlibabaTraceAnalysis\\SplitResult\\batch_task_'
# 需要保留的列
save_list = [0, 1, 2, 3, 4, 5, 6, 7, 8]
# 时间戳所在列
timestamp_index = 5
