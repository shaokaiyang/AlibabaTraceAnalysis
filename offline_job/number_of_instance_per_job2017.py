...
if __name__ == '__main__':
    ...
    reader = pd.read_csv(file_input_path, header=None, usecols=[2, 4])
    # 将读取到的提交时间转化为列表进行处理
    ...
    save1 = pd.DataFrame({'number_of_instance_per_job2017': number_list})
