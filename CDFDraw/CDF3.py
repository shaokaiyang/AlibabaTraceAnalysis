...
line1, = plt.plot(x1, y1, 'r-', label='First_Day_Task_Duration', linewidth=1)
line2, = plt.plot(x2, y2, 'b--', label='Second_Day_Task_Duration', linewidth=1)
...
plt.xlabel('Task Duration(Second)')
plt.savefig('2018duration_cdf.jpg', bbox_inches='tight')
