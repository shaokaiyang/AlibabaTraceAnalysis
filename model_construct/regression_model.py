...
# 加载数据
data = "./Muses_output50clients.csv"
...
# 避免过拟合采用交叉验证，验证集占训练集的30%,固定随机种子
# test_size 测试集大小  train_size训练集大小  random_state随机数生成器若设置则每次产生的随机数是一样的  shuffle 是否在拆分之前打乱数据  stratify 是否分层拆分
