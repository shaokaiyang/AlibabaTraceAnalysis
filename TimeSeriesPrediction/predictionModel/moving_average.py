...
currency_moving_avg['Value'] = train['Value'].rolling(2880).mean().iloc[-1]
currency_moving_avg.to_csv('moving_average.csv', index=0)
...
plt.ylabel('Currency')
plt.legend(loc='best')
plt.savefig('moving_average.jpg', bbox_inches='tight')
plt.show()
